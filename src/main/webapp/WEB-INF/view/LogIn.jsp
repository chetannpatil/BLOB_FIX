...
<p style="color: white; font-family:monospace;  font-size: 70pt; " align="center"   >Blob fix</p>
...
<%-- <p style="color: white;" >EMAIL-ID :&nbsp; :<input  type="text" name="name" value="${email }" /> --%>

<p style="color: white;" >EMAIL-ID :&nbsp; :<input  type="text" name="name"  />
